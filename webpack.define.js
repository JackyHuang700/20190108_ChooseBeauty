...
module.exports = {
  ...
  htmlWebpackPluginSetting: function (mode) {
    ...
    htmlWebpackPluginList.push(
      ...
      new HtmlWebpackPlugin({
        inject: false,
        template: path.resolve(__dirname, 'ClientApp/ejs/index_2/giftRecord.ejs'),
        filename: path.resolve(__dirname, 'giftRecord.html'),
        chunks: ['index'],
        HtmlWebpackPluginOverride: true,
        // hash:true,//防止缓存
        outputFile: {
      ...
      new HtmlWebpackPlugin({
        inject: false,
        template: path.resolve(__dirname, 'ClientApp/ejs/index_2/blogManagement.ejs'),
        filename: path.resolve(__dirname, 'blogManagement.html'),
        chunks: ['index'],
        HtmlWebpackPluginOverride: true,
        // hash:true,//防止缓存
        outputFile: {
